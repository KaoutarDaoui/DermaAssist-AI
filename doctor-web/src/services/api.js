...
export const consultations = {
  create: (patientId) =>
    apiClient.post("/consultations", { patient_id: patientId }),
...
export const images = {
  ...
  list: (consultationId) =>
    apiClient.get(`/consultations/${consultationId}/images`),
};

export const ai = {
  analyze: (consultationId) => apiClient.post(`/ai/analyze/${consultationId}`),
  getResult: (consultationId) => apiClient.get(`/ai/result/${consultationId}`),
